...
use Incept\Framework\Schema\Validator;
 ...
 */
$this('event')->on('system-schema-create', function (
 ...
 * @param ResponseInterface $response
 */
$this('event')->on('system-schema-detail', function (
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
 ...
 * @param ResponseInterface $response
 */
$this('event')->on('system-schema-remove', function (
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
 ...
 * @param ResponseInterface $response
 */
$this('event')->on('system-schema-restore', function (
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
  ...
  // 1. Get Data
  //get the system detail
  $this('event')->call('system-schema-detail', [
 ...
 * @param ResponseInterface $response
 */
$this('event')->on('system-schema-search', function (
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
 ...
 * @param ResponseInterface $response
 */
$this('event')->on('system-schema-update', function (
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
