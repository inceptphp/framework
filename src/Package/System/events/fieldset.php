...
use Incept\Framework\Fieldset\Validator;
 ...
 */
$this('event')->on('system-fieldset-create', function (
 ...
 * @param ResponseInterface $response
 */
$this('event')->on('system-fieldset-detail', function (
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
 ...
 * @param ResponseInterface $response
 */
$this('event')->on('system-fieldset-remove', function (
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
 ...
 * @param ResponseInterface $response
 */
$this('event')->on('system-fieldset-restore', function (
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
  ...
  //get the system detail
  $emitter->call('system-fieldset-detail', [
 ...
 * @param ResponseInterface $response
 */
$this('event')->on('system-fieldset-search', function (
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
 ...
 * @param ResponseInterface $response
 */
$this('event')->on('system-fieldset-update', function (
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
